...
class RetourArticleController extends Controller
{
    ...
    {
       $ventes = DB::table('ventes')->Where([['deleted_at', NULL],['vente_materiel_id', NULL],['divers',0],['attente',0],['proformat',0]])->get();
        ...
        $content = '<div class="container-table">
                        <table border="1" cellspacing="-1" width="100%">
                            <tr>
                                ...
                                <th cellspacing="0" border="2" width="10%" align="center">Qté vendue</th>
                                <th cellspacing="0" border="2" width="10%" align="center">Qté retournée</th>
