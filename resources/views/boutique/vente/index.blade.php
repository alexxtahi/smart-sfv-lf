                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="quantite" placeholder="Qté à vendre">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Qt&eacute; &agrave; vendre *</label>
                                    <input type="number" name="quantite" ng-model="article.quantite" class="form-control" id="quantite_add" placeholder="Qté à vendre">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
