...
<div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
        <form id="formAjout" ng-controller="formAjoutCtrl" action="#">
            <input type="text" id="idUniteModifier" ng-model="unite.id" ng-hide="true" class="hidden">
            @csrf
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="quantite_unite">Quantit&eacute; du lot</label>
                        <input type="number" min="1" id="quantite_unite" name="quantite_unite" ng-model="unite.quantite_unite" class="form-control" placeholder="Quantité du lot" required>
                    </div>
                </div>
                <!-- /.box-body -->
