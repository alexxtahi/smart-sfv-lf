...
<table id="table" class="table table-primary table-striped box box-primary"
               ...
               data-search="true" 
               data-toggle="table"
               data-url="{{url('parametre',['action'=>'liste-clients'])}}"
               data-unique-id="id"
        ...
        <form id="formAjout" ng-controller="formAjoutCtrl" action="#">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <input type="text" class="hidden" id="idClientModifier" ng-hide="true" ng-model="client.id"/>
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="regime_id" id="regime_id" ng-model="client.regime_id" class="form-control" required>
                       ...
                       <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="nation_id" id="nation_id" ng-model="client.nation_id" class="form-control" required>
...
<script type="text/javascript">
    ...
    $(function () {
       $table.on('load-success.bs.table', function (e, data) {
        ...
        $("#searchByNation").change(function (e) {
            ...
            if(nation == 0){
                $table.bootstrapTable('refreshOptions', {url: "{{url('parametre', ['action' => 'liste-clients'])}}"});
            }else{
              $table.bootstrapTable('refreshOptions', {url: '../parametre/liste-clients-by-nation/' + nation});
            }
        });
    ...
    function detailClientRow(idClient){
        window.open("../parametre/fiche-client/" + idClient,'_blank');
    }
