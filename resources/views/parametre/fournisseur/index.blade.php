...
<table id="table" class="table table-primary table-striped box box-primary"
               ...
               data-search="true" 
               data-toggle="table"
               data-url="{{url('parametre',['action'=>'liste-fournisseurs'])}}"
               data-unique-id="id"
        ...
        <form id="formAjout" ng-controller="formAjoutCtrl" action="#">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <input type="text" class="hidden" id="idFournisseurModifier" ng-hide="true" ng-model="fournisseur.id"/>
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                       ...
                       <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="nation_id" id="nation_id" ng-model="fournisseur.nation_id" class="form-control" required>
    ...
    $(function () {
       $table.on('load-success.bs.table', function (e, data) {
         ...
         $("#searchByNation").change(function (e) {
            ...
            if(nation == 0){
                $table.bootstrapTable('refreshOptions', {url: "{{url('parametre', ['action' => 'liste-fournisseurs'])}}"});
            }else{
              $table.bootstrapTable('refreshOptions', {url: '../parametre/liste-fournisseurs-by-nation/' + nation});
            }
        });
      ...
      $("#formAjout").submit(function (e) {
            ...
            var $ajaxLoader = $("#formAjout .loader-overlay");
             ...
             if (ajout==true) {
                var methode = 'POST';
                var url = "{{route('parametre.fournisseurs.store')}}";
             }else{
                var id = $("#idFournisseurModifier").val();
                var methode = 'PUT';
                var url = 'fournisseurs/' + id;
             }
